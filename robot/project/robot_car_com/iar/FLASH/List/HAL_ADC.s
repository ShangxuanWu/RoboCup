...
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  F:\robot _init\robot\lib\LPLD\HAL_ADC.c                 /
//    Command line =  "F:\robot _init\robot\lib\LPLD\HAL_ADC.c" -D IAR -D     /
...
// F:\robot _init\robot\lib\LPLD\HAL_ADC.c
//    1 /*
//    2  * --------------"拉普兰德K60底层库"-----------------
//    3  *
...
??LPLD_ADC_SE_Get_21:
        ...
        STR      R0,[R3, #+0]
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LDR.N    R0,??DataTable5_7  ;; 0x40049000
        MOVS     R3,#+0
        STR      R3,[R0, R1, LSL #+2]
        B.N      ??LPLD_ADC_SE_Get_12
??LPLD_ADC_SE_Get_22:
...
??LPLD_ADC_Channel_Init_22:
        ...
        STR      R1,[R2, #+0]
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        LDR.N    R1,??DataTable5_7  ;; 0x40049000
        MOVS     R2,#+0
        STR      R2,[R1, R4, LSL #+2]
        B.N      ??LPLD_ADC_Channel_Init_12
